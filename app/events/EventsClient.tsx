    ...
    try {
        if (navigator.share) {
            await navigator.share({
                title: eventTitle,
                text: `Check out ${eventTitle} by Serente Electronics`,
                url,
            });
        } else {
            ...
            <div className="relative bg-[#EAEAEA] border-b border-gray-200 py-20 sm:py-28 overflow-hidden">
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FFB800]/10 border border-[#FFB800]/20 text-[#D97706] text-xs font-bold uppercase tracking-wider mb-6">
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1A1A1A] tracking-tight mb-6 leading-tight">
                            Connect with <span className="text-[#D97706]">Serente</span> <br className="hidden sm:block" />
                            <span className="text-[#D97706]">Around the World</span>
                        </h1>
