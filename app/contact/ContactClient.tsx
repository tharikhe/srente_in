...
export default function ContactClient() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white relative overflow-hidden font-sans">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-[#FFB800]/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FFB800]/10 border border-[#FFB800]/30 text-[#FFB800] text-sm font-semibold mb-6">
                        <span className="w-2 h-2 rounded-full bg-[#FFB800] animate-pulse"></span>
                        We're Here to Help
                    </div>
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6">
                        Get In <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFB800] to-amber-400">Touch</span>
                    </h1>
                ...
                >
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-5 group">
                                    <div className="w-12 h-12 rounded-2xl bg-[#FFB800]/10 flex items-center justify-center shrink-0 group-hover:bg-[#FFB800] transition-colors duration-300">
                                        <Mail className="w-5 h-5 text-[#FFB800] group-hover:text-[#1A1A1A] transition-colors" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-gray-400 mb-1">Email Us</p>
                                        <a href="mailto:hello@serenteelectronics.com" className="text-lg font-semibold text-white hover:text-[#FFB800] transition-colors break-all">
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-7">
                        <div className="bg-[#141414]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 relative overflow-hidden h-full">
                            ...
                            <div className="absolute top-0 right-0 w-64 h-64 bg-[#FFB800]/10 rounded-full blur-[100px] pointer-events-none" />
                            ...
                            <AnimatePresence mode="wait">
                                {submitted ? (
                                    ...
                                    >
                                        <div className="w-24 h-24 bg-gradient-to-br from-[#FFB800] to-amber-500 rounded-full flex items-center justify-center mb-8 shadow-[0_0_40px_rgba(255,184,0,0.4)]">
                                            <Send className="w-10 h-10 text-[#1A1A1A]" />
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-black/40 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#FFB800]/50 focus:border-[#FFB800] transition-all"
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                onBlur={() => setFocusedInput(null)}
                                                className="w-full bg-black/40 border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-[#FFB800]/50 focus:border-[#FFB800] transition-all appearance-none"
                                            >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <textarea
                                                ...
                                                onBlur={() => setFocusedInput(null)}
                                                className="w-full bg-black/40 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#FFB800]/50 focus:border-[#FFB800] transition-all resize-none"
                                        ...
                                        <button
                                            ...
                                            className="w-full py-5 bg-gradient-to-r from-[#FFB800] to-amber-500 text-[#1A1A1A] font-bold rounded-xl shadow-[0_0_20px_rgba(255,184,0,0.3)] hover:shadow-[0_0_30px_rgba(255,184,0,0.5)] transition-all duration-300 flex items-center justify-center gap-3 group disabled:opacity-70 disabled:cursor-not-allowed"
                                        >
                                            {isSubmitting ? (
                                                <>
