...
export const metadata: Metadata = {
    title: "Quote Request Cart | Electronics Parts Suppliers - Serente Electronics",
    description: "Submit your quote request for electronic components from Serente Electronics. Competitive prices for resistors, condensers, ICs, and more. OEM & ODM electronic components supplier.",
