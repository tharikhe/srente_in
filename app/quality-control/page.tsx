        ...
        <div className="space-y-16 pb-16">
            ...
            <section className="text-center py-16 bg-gradient-to-b from-brand-teal/5 to-transparent rounded-3xl relative overflow-hidden">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto px-4 relative z-10">
                    At Serente Electronics, quality is not just a promise—it's our core operational principle. We implement rigorous testing and visual inspections to ensure every component meets the highest industry standards.
                </p>
            </section>
                ...
                {[
                    {
                        ...
                        desc: "Our quality management systems are certified to international standards, ensuring consistent performance and service."
                    },
                    {
                        icon: Microscope,
                        title: "Rigorous Inspection",
                        desc: "Every incoming batch undergoes a comprehensive 3-tier inspection process: Visual, Dimensional, and Functional testing."
                    },
                    {
                        icon: FileCheck,
                        title: "Full Traceability",
                        desc: "We maintain complete documentation and lot traceability for all components, from manufacturer to delivery."
                    }
                ].map((item, i) => (
            ...
            <section className="bg-gray-50 rounded-3xl p-8 md:p-12">
                ...
                <div className="space-y-8">
                    {[
                        { step: "01", title: "Visual Inspection", desc: "Examination of packaging, labels, and physical condition of components for any signs of damage, oxidation, or counterfeiting." },
                        { step: "02", title: "Dimensional Verification", desc: "Measurement of component dimensions against manufacturer datasheets to ensure exact specifications." },
                        { step: "03", title: "X-Ray Analysis", desc: "Non-destructive testing to verify internal die structure and bond wire integrity for complex ICs." },
                        { step: "04", title: "Solderability Testing", desc: "Ensuring proper lead termination and wetting characteristics for reliable PCB assembly." }
                    ].map((step, i) => (
            ...
            <section className="text-center">
                ...
                <p className="mt-6 text-sm text-gray-500 max-w-2xl mx-auto">
                    We strictly adhere to IDEA-STD-1010-B standards for the inspection of electronic components. We have a zero-tolerance policy for counterfeit parts.
                </p>
            </section>
        </div>
    );
