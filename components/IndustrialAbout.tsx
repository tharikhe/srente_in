            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="flex flex-col lg:flex-row shadow-lg border border-gray-200">
                        ...
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-20">
                            {images.map((_, idx) => (
                                <button 
                                    ...
                                    className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${currentImage === idx ? 'bg-[#FFB800] w-6' : 'bg-white/50 hover:bg-white'}`}
                    ...
                    <div className="lg:w-1/2 bg-[#F8F9FA] p-8 md:p-16 flex flex-col justify-center">
                        ...
                        <h3 className="font-mono text-sm md:text-base font-bold text-[#D97706] mb-8 uppercase tracking-wide">
                        ...
                        <div className="mt-10">
                            <Link href="/about" className="inline-flex items-center gap-3 bg-[#1A1A1A] hover:bg-[#FFB800] hover:text-[#1A1A1A] text-white px-8 py-3.5 font-display font-bold uppercase tracking-wider transition-colors duration-300">
