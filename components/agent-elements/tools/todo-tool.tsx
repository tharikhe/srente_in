...
import { CheckIcon, IconArrowRight } from "@/components/agent-elements/icons";
import { TextShimmer } from "../text-shimmer";
import { getToolStatus, areToolPropsEqual } from "@/components/agent-elements/utils/format-tool";
