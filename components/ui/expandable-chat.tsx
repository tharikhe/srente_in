    ...
    return (
        <div className={cn('fixed z-50', positionClasses[position])}>
            ...
            <button
                ...
                className="ml-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#FFFF00] text-[#1A1A1A] shadow-lg hover:bg-[#FFF566] transition-all active:scale-95 font-bold"
            >
                {isOpen ? (
